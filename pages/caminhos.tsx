...
const caminhos: Caminho[] = [
  ...
  },
  {
    ...
    extras: [
      {
        title:
          "Se preferir, você pode usar essa plataforma online para programar",
  ...
  },
  {
    ...
    extras: [
      {
        title:
          "Se você sabe inglês, recomendo assistir esse curso completo sobre algoritmos.",
  ...
  },
  {
    ...
    caminho: [
      ...
      {
        title:
          "Aprendendo a ler o manual e passando argumentos para os comandos",
  ...
  },
  {
    ...
    caminho: [
      {
        title:
          "Uma noção geral sobre como conseguir um emprego como programador - Pt 1",
        link: "https://www.youtube.com/watch?v=6IUivbVNDy0",
      },
      {
        title:
          "Uma noção geral sobre como conseguir um emprego como programador - Pt 2",
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta name="description" content="Caminhos" />
